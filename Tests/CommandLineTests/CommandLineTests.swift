...
private struct CannotFindTheBinary: Error, CustomStringConvertible {
...
@discardableResult
private func xscaffold(_ arguments: String..., in directory: URL? = nil) throws -> ProcessResult {
    try run(arguments, in: directory)
}

private func run(_ arguments: [String], in directory: URL? = nil) throws -> ProcessResult {
...
private func decoded(_ result: ProcessResult) throws -> CommandOutput {
...
private let validConfiguration = """
project:
  name: Bookshelf
...
private let invalidConfiguration = """
project:
  name: Bookshelf
